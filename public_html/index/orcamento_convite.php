                        ...
                        <div class="col-md-4">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <span class="glyphicon glyphicon-hdd"></span> <b>Base de Modelos</b>
                                </div>
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon">Convite</span>
                                            <select id="convite_orcamento" class="form-control">
                                                <option value="">Selecione o Convite</option>
                                                <?php
                                                $conexao = new Conexao();
                        ...
                        <div class="col-md-8">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="col-md-4"><span class="glyphicon glyphicon-scale"></span> <b>Simulador de preço</b></div> 
                                            <div class="col-md-4">
                                                <div class="input-group">
                                            ...
                                            <div class="col-md-4">
                                                <div class="btn-group">
                                                    ...
                                                    ?>
                                                    <a class="btn btn-warning btn-group" href="orcamento_convite_salvar.php?acao=limpar" data-toggle="tooltip" data-placement="left" title="Limpa a área de configuração do convite">Limpar <span class="glyphicon glyphicon-erase"></a>
                                                    <a class="btn btn-success btn-group" id="add_convite_carrinho" data-toggle="tooltip" data-placement="left" title="Adiciona o convite ao carrinho"><?= $btn_submit ?> <span class="glyphicon glyphicon-shopping-cart"></span></a>
                                                </div> 
                                            </div> 
                                        </div>
                                    </div>
