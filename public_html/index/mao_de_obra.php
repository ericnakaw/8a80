...
$pageName = "Mão de Obra";
$confDelete = 'mao_de_obra_deletar.php';
        ...
        <div class="container">
            <div class="row">
                <div id="conteudo" class="col-md-04">
                    ...
                    <form action="mao_de_obra_formulario.php" method="POST" role="form">
                        <a href="mao_de_obra_formulario.php">
                            <button class="btn btn-primary" id="<?php echo $tabela['id'] ?>">
                                    <span class="glyphicon glyphicon-plus"></span> Nova Mão de Obra
                            </button>
                        </a>
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                <?php
                                $conexao = new Conexao();
                                $resultado = $conexao->sql_query("SELECT * FROM mao_de_obra ORDER BY nome ASC");
...
//                                    print '<td>' . $tabela['id'] . '</td>';
                                    ...
                                    <!--Botao de editar-->
                                <td>
                                    <a href ="mao_de_obra_formulario.php?id=<?php echo $tabela['id'] ?>" class="btn btn-primary">
