                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control text-uppercase" name="largura" id="largura">
                                ...
                                <option value="indefinido" <?php if($largura=='indefinido'){print 'selected';}?>>À definir</option>
                                <option value="palha" <?php if($largura=='palha'){print 'selected';}?>>Palha</option>
                                <option value="6"  <?php if($largura=='6'){print 'selected';}?>>6 mm</option>
                                <option value="10" <?php if($largura=='10'){print 'selected';}?>>10 mm</option>
                                <option value="15" <?php if($largura=='15'){print 'selected';}?>>15 mm</option>
                                <option value="22" <?php if($largura=='22'){print 'selected';}?>>22 mm</option>
                                <option value="38" <?php if($largura=='38'){print 'selected';}?>>38 mm</option>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control text-uppercase" name="servico" id="servico">
                                ...
                                while ($tabela = mysql_fetch_array($resultado, MYSQL_ASSOC)) {
                                    ?>
                                    <option class="text-uppercase <?php if($tabela["id"]==27){print 'text-danger';} ?>" value="<?= $tabela["id"] ?>§<?= $tabela["nome"] ?>§<?= $tabela["valor"] ?>"><?= $tabela["nome"] ?></option>
                                    <?php
                                }
                                ?>
                            </select>
